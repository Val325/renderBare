void fillBottomTriangle(SDL_Renderer *renderer, Vec2 v1, Vec2 v2, Vec2 v3, float **z_buffer,  triangleInfo triangl){
...
void fillTopTriangle(SDL_Renderer *renderer, Vec2 v1, Vec2 v2, Vec2 v3, float **z_buffer, triangleInfo triangl){
...
void DrawTriangle(SDL_Renderer *renderer, Vec2 v1, Vec2 v2, Vec2 v3, float **z_buffer,  triangleInfo triangl){
